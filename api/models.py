...
class Ingrediente(Base):
    ...
    id_unidad_medida = Column(
        Integer, 
        ForeignKey("lcs_cat.unidades_medida.id_unidad_medida"), 
        nullable = False
    )
...
class Producto(Base):
    ...
    id_categoria = Column(
        Integer, 
        ForeignKey("lcs_cat.categorias_productos.id_categoria"), 
        nullable = False
    )
    nombre = Column(String(100), nullable = False, unique = True)
...
class ProductoIngrediente(Base):
    ...
    __table_args__ = (CheckConstraint("cantidad > 0"), {"schema": "lcs_pro"})
    ...
    id_ingrediente = Column(
        Integer, 
        ForeignKey("lcs_cat.ingredientes.id_ingrediente"), 
        primary_key = True
    )
